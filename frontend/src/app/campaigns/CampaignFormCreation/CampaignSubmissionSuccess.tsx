...
export function CampaignSubmissionSuccess({ formData }: CampaignSubmissionSuccess) {
                        ...
                        <div className="relative bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 md:p-10">
                            ...
                            <div className="text-center mb-8">
                                ...
                                <p className="text-slate-400 text-base leading-relaxed max-w-md mx-auto">
                                    Thank you, <span className="text-white font-semibold">{formData.CreatorName || 'Patient'}</span>.
                                    Your campaign has been submitted to the blockchain and is now awaiting hospital verification.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-8">
                                <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-4">
                                    <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider mb-1.5">Campaign</div>
                                ...
                                <div className="col-span-2 bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 flex items-center gap-3">
                                    <span className="text-xl">⏱️</span>
                                    <div>
                                        <div className="text-xs text-amber-400 font-semibold uppercase tracking-wider mb-0.5">Estimated Verification</div>
                                        <div className="text-white text-sm font-medium">24 – 48 hours via hospital representative</div>
                                    </div>
                                </div>
                            </div>
