...
// GPL = copyleft required to distribute modified code under same license
...
contract ICO is Pausable, Ownable { // pause in case of emergency (assignment), contract owner
    IERC20 public token;
